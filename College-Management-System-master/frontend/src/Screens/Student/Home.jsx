...
import Tnp from "../Tnp";// Tnp import is added 
...
const MENU_ITEMS = [
  ...
  { id: "tnp", label: "T & P", component: Tnp },
...
const Home = () => {
  ...
  // âœ… FIX 1: wrapped with useCallback (no logic change)
  ...
  const renderContent = () => {
    ...
    return MenuItem && <MenuItem userRole="student"/>;
  };
