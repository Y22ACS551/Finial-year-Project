...
import Tnp from "../Tnp"; // Tnp apped import 
...
{ id: "tnp", label: "T & P", component: Tnp },  { id: "exam", label: "Exam", component: Exam },
...
const Home = () => {
  ...
  // âœ… FIX 1: wrap in useCallback (no behavior change)
  ...
  // âœ… FIX 2: include location.search
  useEffect(() => {
  ...
  const renderContent = () => {
    ...
    return MenuItem && <MenuItem userRole="admin"/>;
  };
